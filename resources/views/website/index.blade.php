              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                  <ul class="list-marked-2 box-categories-list">
                    <li><a href="destinasi/{{$destinasi->id}}"><img src="images/{{$destinasi->displayImage}}" alt="" width="368" height="420"/></a>
                      <h5 class="box-categories-title">{{$destinasi->nama_daerah}}</h5>
                    </li>
                  </ul>
                </div>
                @endforeach
